...
class Scanner(BaseScanner):
    ...
    def _group2_unauth_upload(self, bucket: str, base: str, page: str,
        ...
        url = f"{base}/v0/b/{bucket}/o?name={enc}"
        body, status = self._http_post(url, _PROBE_CONTENT, "application/octet-stream")
        # Cleanup
        try:
            enc2 = urllib.parse.quote(_PROBE_FILE, safe="")
            del_url = f"{base}/v0/b/{bucket}/o/{enc2}"
            self._http_delete(del_url)
        except Exception:
            pass
